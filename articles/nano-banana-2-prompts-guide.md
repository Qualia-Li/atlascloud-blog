---
title: "Best Nano Banana 2 Prompts: 3D Figurines, Characters & More"
description: "Master Nano Banana 2 with 15+ proven prompts for 3D figurines, character art, product shots, and more. Includes prompt structure breakdown, tips, and API code examples."
keywords: ["Nano Banana 2 prompts", "Nano Banana 2 prompt guide", "AI image prompts", "3D figurine prompts", "Nano Banana 2 best prompts", "Nano Banana prompt examples"]
slug: "nano-banana-2-prompts-guide"
date: "2026-02-28"
author: "Atlas Cloud Team"
---
# Best Nano Banana 2 Prompts: 3D Figurines, Characters & More
...
```
[Subject/Character] + [Style/Format] + [Material/Finish] +
[Accessories/Details] + [Packaging/Context] + [Lighting/Photography Style]
```
...
```
3D collectible figurine of a medieval knight in full plate armor with gold
trim, sealed in clear blister packaging with illustrated cardboard backing,
hand-painted metallic details, miniature sword and shield accessories
included in package, product photography with studio lighting on clean
white background, sharp macro lens detail
```
...
```
Matte vinyl collectible toy figure of a robot DJ wearing oversized
headphones and a leather jacket, turntable accessory at its feet,
displayed on minimalist white pedestal, Funko Pop proportions with
oversized head and small body, rose gold and midnight blue color scheme,
...
```
Highly detailed anime-style action figure of a female mecha pilot in
a white and red flight suit, dynamic action pose with one arm extended,
translucent green visor on helmet, multiple points of articulation visible,
displayed in premium collector box with window panel showing figure,
Japanese text on packaging, Bandai model kit aesthetic, professional
product photography with dramatic rim lighting
```
...
```
Adorable chibi-style figurine of a dragon tamer with a tiny dragon perched
on their shoulder, oversized eyes, small body with detailed flowing cape,
the dragon has iridescent scales that catch the light, both figures on
a rocky base with painted grass details, displayed without packaging on
a clean surface, warm soft lighting from above, collectible miniature
painting quality, shallow depth of field
```
...
```
Vintage 1980s style action figure of a space commander in a silver
spacesuit with orange accents, stiff pose with limited articulation,
sealed in yellowed blister packaging with retro illustrated card
backing featuring stars and planets, slightly weathered packaging
edges, nostalgic toy store display feel, warm tungsten lighting,
product photography with slight film grain
```
...
```
Semi-realistic 3D rendered portrait of an elven ranger, sharp angular
features, silver hair braided with small leaves, wearing dark green
leather armor with intricate tooling, bow slung across back, forest
background with volumetric light rays filtering through canopy,
Pixar-meets-Lord-of-the-Rings aesthetic, cinematic color grading
with warm highlights and cool shadows, medium close-up composition
```
...
```
Full-body character design sheet of a cyberpunk street samurai, front
and three-quarter view, neon-lit augmented eyes, asymmetric hairstyle
with shaved side, tactical jacket with glowing circuit patterns, cybernetic
left arm with exposed chrome mechanics, utility belt with tech gadgets,
dark urban background with rain and neon reflections, character design
concept art style, clean lines, professional game art quality
```
...
```
Cute cartoon mascot character of a round penguin wearing a tiny chef
hat and apron, holding a spatula, simple geometric shapes, bold black
outlines, flat color fills with subtle shading, cheerful expression
with rosy cheeks, standing on a small ice cream sundae base, vector
illustration style, bright pastel color palette, clean white background
```
...
```
Stylized 3D portrait bust of a jazz musician, exaggerated proportions
with slightly oversized head and hands, wearing a porkpie hat and
round sunglasses, playing a miniature saxophone, rich mahogany skin
tones with warm studio lighting, subtle smoke wisps in background,
sculpted clay aesthetic with visible texture, museum display lighting,
artistic collectible quality
```
...
```
Sleek wireless earbuds floating in mid-air, matte black with brushed
gold accents, charging case open below showing magnetic charging
contacts, ambient particles of light surrounding the earbuds,
dark gradient background with subtle blue glow, premium tech product
photography, Apple-style minimalist presentation, professional
studio lighting with soft reflections on surface
```
...
```
Artisan chocolate truffle collection in an open luxury gift box,
six truffles with different finishes -- dark chocolate gloss, white
chocolate drizzle, gold leaf accent, cocoa powder dusted, raspberry
ganache, and caramel swirl -- each in individual paper cups, black
velvet lining visible, shallow depth of field focusing on front row,
warm overhead lighting with soft shadows, gourmet food photography
style, rich and indulgent color palette
```
...
```
Futuristic sneaker design concept, high-top silhouette with
translucent sole revealing internal air cushion mechanism, upper
made of woven carbon fiber texture in midnight blue, iridescent
heel counter, floating lace system with magnetic closures, side
profile view on reflective dark surface, dramatic studio lighting
with colored gels creating orange and teal highlights, sneaker
culture photography style, hyper-detailed render
```
...
```
Detailed miniature diorama of a Japanese autumn garden, tiny maple
trees with red and orange leaves, small wooden bridge over a pebble
stream, miniature stone lantern, moss-covered ground, tilt-shift
photography effect making real scenery look tiny, warm golden hour
lighting, extremely detailed at miniature scale, displayed on wooden
base with glass dome cover, museum-quality miniature art
```
...
```
Floating island in a sunset sky, cascading waterfalls pouring off
the edges into clouds below, ancient stone ruins covered in
bioluminescent vines on the island surface, a single massive tree
at the center with golden leaves, small birds circling the canopy,
volumetric clouds and god rays, fantasy concept art style, rich warm
color palette with deep purples and golds, digital painting quality,
...
```
Isometric view of a cozy study room, warm wooden desk with open
books and a steaming coffee mug, floor-to-ceiling bookshelves filled
with colorful books, vintage globe on corner table, soft reading lamp
casting warm pool of light, rain visible through window, cat curled
up on armchair, low-poly 3D render style with clean geometry,
soft pastel color palette, detailed miniature scene, isometric game
art aesthetic
```
...
```
3D collectible figurine of a Teutonic knight in white surcoat over
chainmail, iron cross heraldry on chest, hand-painted matte finish
with metallic silver armor highlights, shield and mace accessories
on sprue beside figure, sealed in clear blister pack with illustrated
medieval manuscript-style card backing, product photography with
soft studio lighting, shallow depth of field, clean white background
```
...
# Define prompt -- use any of the prompts from this guide
prompt = """3D collectible figurine of a cyberpunk hacker in a hooded
jacket with glowing circuit patterns, multiple monitors and keyboards
as miniature accessories, seated pose on a desk-shaped base, neon green
and dark purple color scheme, sealed in premium collector box with
transparent window panel, product photography with dramatic colored
...
To batch-generate multiple prompts:
...
prompts = [
    "3D figurine of a pirate captain with treasure chest accessory, blister packaging, studio lighting",
    "Chibi-style vinyl toy of a space explorer with helmet, matte white finish, pedestal display",
    "Vintage 1980s action figure of a jungle adventurer, yellowed blister pack, retro card art",
]
...
while len(results) < len(request_ids):
    for rid in request_ids:
        ...
        if status["status"] == "completed":
            results[rid] = status["output"]["image_url"]
            print(f"Completed: {results[rid]}")
    time.sleep(3)
```
...
Start with the prompts in this guide, adapt them to your specific needs, and iterate from there. Nano Banana 2 is available on [Atlas Cloud](https://www.atlascloud.ai?utm_medium=article&utm_source=blog&utm_campaign=nano-banana-2-prompts-guide) with $1 free credit at sign-up -- enough to test a dozen of these prompts and see the results firsthand.

> [Get $1 Free Credit on Atlas Cloud -- Try Nano Banana 2 Prompts](https://www.atlascloud.ai?utm_medium=article&utm_source=blog&utm_campaign=nano-banana-2-prompts-guide)

---
## Related Articles

- [Nano Banana 2 on Atlas Cloud: Google's Viral AI Image Generator](https://www.atlascloud.ai/blog/nano-banana-2-api-guide?utm_medium=article&utm_source=blog&utm_campaign=nano-banana-2-prompts-guide)
- [15 Best Seedance 2.0 Prompts: The Ultimate Guide to Create Viral Videos](https://www.atlascloud.ai/blog/best-seedance-2-0-prompts-guide?utm_medium=article&utm_source=blog&utm_campaign=nano-banana-2-prompts-guide)
- [Atlas Cloud Image Generation: Flux, Imagen & Ideogram API Guide](https://www.atlascloud.ai/blog/image-generation-api-guide?utm_medium=article&utm_source=blog&utm_campaign=nano-banana-2-prompts-guide)
- [Best AI Image Generation Models 2026](https://www.atlascloud.ai/blog/best-ai-image-generation-models-2026?utm_medium=article&utm_source=blog&utm_campaign=nano-banana-2-prompts-guide)
- [How to Generate AI Product Photography](https://www.atlascloud.ai/blog/how-to-generate-ai-product-photography?utm_medium=article&utm_source=blog&utm_campaign=nano-banana-2-prompts-guide)
